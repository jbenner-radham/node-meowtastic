...
- Upgraded `read-package-up` dependency from `11.0.0` to `12.0.0`.

### Fixed

- Description being displayed twice in help text when provided as a configuration option.
...
- Missing theme documentation for commands.
...
[0.7.2]: https://github.com/jbenner-radham/node-meowtastic/compare/v0.7.1...v0.7.2
[0.7.1]: https://github.com/jbenner-radham/node-meowtastic/compare/v0.7.0...v0.7.1
[0.7.0]: https://github.com/jbenner-radham/node-meowtastic/compare/v0.6.0...v0.7.0
